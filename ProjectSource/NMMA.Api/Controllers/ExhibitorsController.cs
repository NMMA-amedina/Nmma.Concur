...

{
    ...
    public class ExhibitorsController : BaseApiController
    {
        ...
        List<Models.Exhibitor > LocalMap(List<Nmma.Domain.Models.Shows.Exhibitor> source)
        {
        ...
        List<Models.ExhibitorBadge> LocalMap(List<Nmma.Domain.Models.Shows.ExhibitorBadge> source)
        {
        ...
        List<Models.ExhibitorContact> LocalMap(List<Nmma.Domain.Models.Shows.ExhibitorBadge> source, bool flag)
        {
            var exhContacts = new List<Models.ExhibitorContact>();
